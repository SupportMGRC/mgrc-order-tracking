...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div>
                <div id="teamlist">
                    <div class="team-list {{ request('view') == 'list' ? 'list-view-filter' : 'grid-view-filter' }} row"
                        id="team-member-list">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0">
                                <div class="modal-body">
                                    <form autocomplete="off" id="memberlist-form" action="{{ route('users.store') }}"
                ...
                @if(request()->has('modal') && request('modal') === 'edit' && request()->has('id') && $editUser = \App\Models\User::find(request('id')))
                    <div class="modal fade show" id="editUserModal" style="display: block; background: rgba(0,0,0,0.5);"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0">
                                <div class="modal-body">
                                    <form autocomplete="off" action="{{ route('users.update.post', $editUser->id) }}"
                                        method="POST" class="needs-validation" novalidate>
                                        @csrf
                                    ...
                                    <div class="mt-2 text-center">
                                        ...
                                        <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                            ...
                                            <p class="text-muted mx-4 mb-0">Are you sure you want to remove
                                                {{ $deleteUser->first_name }} {{ $deleteUser->last_name }}?</p>
                                        </div>
                                    </div>
